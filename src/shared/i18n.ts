...
const EN_MESSAGES = {
  ...
  popupPausedEmptyBody: "Turn on the extension to highlight, warn, or collapse works.",
  ...
  popupStatCollapseWork: "Collapse work",
  ...
  contentCollapseMatchNoReasons: "Collapse rule match: This work matches tags you collapse on listings.",
  contentCollapseMatchMessage: "Collapse rule match: This work matches tags you collapse on listings: $1.",
  contentCollapsedExpanded: "Collapsed work is expanded for this page.",
  contentHideAgain: "Collapse again",
  contentClickToExpand: "Click to expand",
  contentCollapsedNoReasons: "This work is collapsed by a collapse rule.",
  contentCollapsedOneReason: "This work is collapsed by a collapse rule: $1",
  contentCollapsedMultipleReasons: "This work is collapsed by collapse rules: $1",
...
const ZH_CN_MESSAGES: Record<MessageKey, string> = {
  ...
  contentCollapseMatchNoReasons: "折叠规则命中：这篇作品含有你在列表页会折叠的标签。",
  contentCollapseMatchMessage: "折叠规则命中：这篇作品含有你在列表页会折叠的标签：$1。",
  contentCollapsedExpanded: "这篇折叠作品已临时展开。",
  contentHideAgain: "重新折叠",
  contentClickToExpand: "展开",
  contentCollapsedNoReasons: "这篇作品已按折叠规则折叠。",
  contentCollapsedOneReason: "这篇作品已按折叠规则折叠：$1",
  contentCollapsedMultipleReasons: "这篇作品已按折叠规则折叠：$1",
